...
import './style/PromoterEarnings.css'
...
function PromoterEarnings() {
  ...
  const [rows, setRows] = useState([
    ...
    { id: 2, name: "Jane Smith",     Tearnings:"Rs.",paid:"Rs.",payable:"Rs."},
    { id: 3, name: "Alice Johnson",  Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
    { id: 4, name: "Bob Brown",      Tearnings:"Rs.",paid:"Rs.",payable:"Rs."},
    { id: 6, name: "Charlie Davis",  Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
    { id: 7, name: "Charlie Davis",  Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
    { id: 8, name: "Charlie Davis",  Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
    { id: 9, name: "Charlie Davis",  Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
    { id: 10, name: "Charlie Davis", Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
    { id: 11, name: "Charlie Davis", Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
    { id: 12, name: "Charlie Davis", Tearnings:"Rs.",paid:"Rs.",payable:"Rs." },
